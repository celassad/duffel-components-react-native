import PaidSeatIndicator from 'duffel-components-react-native/src/Components/DuffelAncillaries/seats/SeatPaidIndicator';
import React from 'react';
import { StyleSheet, Text, TouchableHighlight, View } from 'react-native';
import { colors } from '../../../colors';
import { ELEMENT_BORDER_WIDTH, MARGIN } from './helpers';

const AvailableSeat = React.memo(({width, seatLabel, isFeePayable, selected}:{width:number, seatLabel:string, isFeePayable: boolean, selected: boolean})=>{
  return(
    <TouchableHighlight onPress={()=>{console.log(seatLabel)}}>
    <View
      style={[
        {
          width: width,
    ...
    >
      <Text style={selected ? styles.SelectedSeatText : styles.AvailableSeatText}>{seatLabel}</Text>
